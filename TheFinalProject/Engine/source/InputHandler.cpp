...
void InputHandler::Initialize(HWND& window, float moveSpeed, float mouseSens)
{
...
void InputHandler::KeyboardInput(float dt, Camera& camera, Rasterizer& rasterizer, 
...
void InputHandler::MouseInput(float dt, Camera& camera)
{
...
void InputHandler::CheckInput(float dt, Camera& camera, Rasterizer& rasterizer,
									Tessellation& tessellator, Scene& theScene, ConstantBuffers& constBuffs, 
									ID3D11DeviceContext* deviceContext,	BackFaceCulling& culling, 
									PostProcessing& postProcess)
{
